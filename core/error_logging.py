"""
Automatic error logging, same pattern as the Java Edition launcher
(PC and Android): every unhandled exception gets written to a timestamped
file with a full traceback instead of crashing silently.
"""
...
LOG_DIR = os.path.join(os.path.expanduser("~"), ".archclient_bedrock", "error_logs")
