...
def main():
    ...
    # ttkbootstrap có kèm theo font/icon riêng (assets/icons/bootstrap.ttf...)
    # nhưng PyInstaller không tự dò ra các file dữ liệu này -> thiếu file
    # khi chạy .exe (FileNotFoundError: bootstrap.ttf). Ép PyInstaller gom
    # hết toàn bộ package (code + data + hidden imports) của ttkbootstrap.
